        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="../../includes/post/add.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="mb-2">  
                <div class="form-group m-0">
                    <label for="title">Title</label>
                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter title" value="<?php echo($_SESSION['old']['title']) ?? null ?>">
                  </div>
                  ...
                  <div class="form-group m-0">
                        ...
                        <select class="form-control" name="category">
                          <option value="<?php echo($_SESSION['old']['category']) ?? null ?>"><?php echo($_SESSION['old']['category']) ?? null ?></option>
                    ...
                    <textarea class="form-control" rows="10" name="paragraph1" placeholder="Write ..."><?php echo($_SESSION['old']['paragraph1']) ?? null ?></textarea>
                    </div>
                    ...
                    <textarea class="form-control" rows="10" name="paragraph2" placeholder="Write ..."><?php echo($_SESSION['old']['paragraph2']) ?? null ?></textarea>
                    </div>
                    ...
                    <div class="mb-2">
                    <div class="form-group m-0">
                    <label>Paragraph third</label>
                    <textarea class="form-control" rows="10" name="paragraph3" placeholder="Write ..."><?php echo($_SESSION['old']['paragraph3']) ?? null ?></textarea>
                    </div>
                    <span class="form-text text-danger" role="alert" ></span>
                    </div>
                    ...
                    <textarea class="form-control" rows="10" name="paragraph4" placeholder="Write ..."><?php echo($_SESSION['old']['paragraph4']) ?? null ?></textarea>
                    </div>
                    <span class="form-text text-danger" role="alert" ></span>
                    </div>
                ...
                <div class="card-footer">
                  <button type="submit" name="post-submit-btn" class="btn btn-primary">ADD</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
