                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      echo "<tr>
                        ...
                        <td><a href='update.php?slug=".$post['slug']."' name='delete-form' class='btn btn-warning' type='submit' '>UPDATE</a></td>
                        <td>
                          <form action='../../includes/post/delete.php' method='POST' class=''>
                            <input name='slug' type='hidden' class='form-control' value='".$post['slug']."'>
                            <button name='post-delete-btn' class='btn btn-danger' type='submit' '>DELETE</button>
                          </form>
                        </td>
                      </tr>"; $i++;} ?>
                    </tbody>
