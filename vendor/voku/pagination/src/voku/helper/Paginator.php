...
class Paginator
{
     ...
     * @var string
     */
    private $_paginatorStartCssClass = '';

    /**
     * @var string
     */
    private $_paginatorEndCssClass = '';
    ...
    public function page_links(string $path = '?'): string
    {
        ...
        if ($lastpage > 1) {
            $pagination .= '<ul class="pagination pagination-sm m-0 float-right ' . $this->_paginatorUlCssClass . '" data-pagination-current="' . $this->_pageIdentifierFromGet . '" data-pagination-prev="' . $prevDataAttribute . '" data-pagination-next="' . $nextDataAttribute . '" data-pagination-length="' . $lastpage . '">';
            ...
            if ($this->_pageIdentifierFromGet > 1) {
                ...
                $pagination .= '<li class="page-item ' . $this->_paginatorStartCssClass . '"><span class="page-link">' . $this->_paginatorStartChar . '</span></li>';
            }
            ...
            if ($lastpage < 7 + ($this->_adjacent * 2)) {
                ...
                if ($this->_pageIdentifierFromGet != 5) {
                    $pagination .= '<liclass="page-item"><span class="page-link">&hellip;</span></li>';
                }
            ...
            if ($this->_pageIdentifierFromGet < $counter - 1) {
                ...
                $pagination .= '<li class="page-item ' . $this->_paginatorEndCssClass . '"><span class="page-link">' . $this->_paginatorEndChar . '</span></li>';
            }
    ...
    private function createLiCurrentOrNot(string $path, int $counter): string
    {
        ...
        if ($counter == $this->_pageIdentifierFromGet) {
            $html .= '<li class="page-item ' . $this->_paginatorActiveElementCssClass . '">' . $currentTextAndOrLink . '</li>';
        } else {
